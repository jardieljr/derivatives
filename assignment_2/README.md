...
* The call price of american option is €15.19 (using app).
...
* The put price of american option is €3.16 (using app).
* The put price of american option is €3.8922 (using binomial model).
