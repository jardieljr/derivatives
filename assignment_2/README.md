...
In order to perform the LSM technique we built an application in python to be used as an additional tool with the excel model implemented. Below you are able to have the first impressions of this app and the inputs needed to use it. The application is available for both Mac and Windows users.
